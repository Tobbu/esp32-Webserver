...
#define ESP_WIFI_SSID "examplewifi" //name des wifis
#define ESP_WIFI_PASS "examplepassword" //password vom wifi
#define TAG "name"
...
static void https()
{
    esp_http_client_config_t config = {
        .url = "http://worldclockapi.com/api/jsonp/cet/now?callback=mycallback", //Aktuelle Zeit
